...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MARK_ONLY_MODE" -parent ${Page_0}
...
proc update_PARAM_VALUE.MARK_ONLY_MODE { PARAM_VALUE.MARK_ONLY_MODE } {
	# Procedure called to update MARK_ONLY_MODE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MARK_ONLY_MODE { PARAM_VALUE.MARK_ONLY_MODE } {
	# Procedure called to validate MARK_ONLY_MODE
	return true
}
...
proc update_MODELPARAM_VALUE.MARK_ONLY_MODE { MODELPARAM_VALUE.MARK_ONLY_MODE PARAM_VALUE.MARK_ONLY_MODE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MARK_ONLY_MODE}] ${MODELPARAM_VALUE.MARK_ONLY_MODE}
}
